...
public class DataInitializer
{
    ...
    private async Task SeedUsers()
    {
        ...
        {
            await _userManager.CreateAsync(adminUser, "Hejsan123#");

            await _userManager.AddToRoleAsync(adminUser, "Admin");

            await _userManager.CreateAsync(cashierUser, "Hejsan123#");

            await _userManager.AddToRoleAsync(cashierUser, "Cashier");
